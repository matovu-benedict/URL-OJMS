	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
             <li class="nav-item cta mr-md-2"><a href="<?php echo web_root; ?>admin/" class="nav-link">Admin login</a></li>
             <?php }else{ ?>
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'applicant/';?>"><i class="fa fa-user"></i> Welcome &nbsp; <?php echo $appl->FNAME. ' '.$appl->LNAME;?></a></li>

              <li class="nav-item cta cta-colored"><a class="nav-link" href="<?php echo web_root.'logout.php';?>"><i class="fa fa-user"></i> Logout</a></li>
             <?php } ?> 
      ...
      <div class="container">
         <div class="row mb-5">
        	<div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <p>Unique Recruiters Limited-Online Jobs Management System,connects qualified professionals like you to their dream jobs and employers to the best talent to help grow their businesses.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Advertising Job Vacancies </a></li>
                <li><a href="#" class="py-2 d-block"> making screening for companies</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  &copy;<script>document.write(new Date().getFullYear());</script> 	By Matovu Benedict | 2018-B072-30009 
  </p>
          </div>
        </div>
      </div>
