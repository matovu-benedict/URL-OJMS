 ...
 */
     ...
     <?php if (isset($_SESSION['APPLICANTID'])) { ?> 
                <?php
                    ...
                    $sql = "SELECT count(*) as 'COUNTNOTIF' FROM `tbljob` ORDER BY `DATEPOSTED` ASC";
                    $mydb->setQuery($sql);
           ...
           <!-- <li class="nav-item <?php  if(isset($_GET['q'])) { if($_GET['q']=='Contact'){ echo 'active'; }else{ echo ''; }}  ?>"><a  class="nav-link" href="<?php echo web_root; ?>index.php?q=Contact">Contact</a></li> -->
            <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
             ...
             <?php }else{ ?>
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'applicant/';?>"><i class="fa fa-user"></i> Welcome &nbsp; <?php echo $appl->LNAME/*. ' '.$appl->LNAME */;?></a></li>
