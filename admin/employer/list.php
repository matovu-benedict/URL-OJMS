...
?> 
	<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header">List of Employers  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Add New Employer</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
							...
							<table id="dash-table" class="table table-striped  table-hover table-responsive" style="font-size:12px" cellspacing="0">
							  ...
							  <tbody>
							  	<?php   
							  		...
							  		$mydb->setQuery( "SELECT * FROM `tblemployer` e, `tblcompany` c WHERE e.COMPANYID=c.COMPANYID");
